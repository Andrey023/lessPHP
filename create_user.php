...
<body>
    ...
    <main id="js-page-content" role="main" class="page-content mt-3">
        ...
        <form action="api/addNewUser.php" method="GET">
            <div class="row">
                <div class="col-xl-6">
                        ...
                        <div class="panel-container">
                            ...
                            <div class="panel-content">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nameUser" id="simpleinput" class="form-control">
                                </div>

                                <!-- title -->
                                <div class="form-group">
                                    <label class="form-label" for="simpleinput">Место работы</label>
                                    <input type="text" name="placeWork" id="simpleinput" class="form-control">
                                </div>
                            ...
                            <div class="panel-content">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name = "status" id="example-select">
                                        ...
                                        <option value = "afk">Отошел</option>
                                        <option value = "notAvailable">Не беспокоить</option>
                                    </select>
                                </div>
