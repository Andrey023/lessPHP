...
<body>
    <div class="blankpage-form-field">
        ...
        <div class="card p-4 border-top-left-radius-0 border-top-right-radius-0">
            <?php 
                if (isset($_SESSION["fleshMsg"])):
            ?>
                <div class="alert alert-<?php echo $_SESSION["fleshMsg"]['status']?>">
                    <?php echo $_SESSION['fleshMsg']['msg'] ?>
                </div>
            <?php 
                SESSION_UNSET();
                endif;
            ?>
            <form action="/api/autorisationUser.php" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="password" id="password" name="pass" class="form-control" placeholder="" >
                </div>
                <div class="form-group text-left">
                    <div class="custom-control custom-checksbox">
