                            ...
                            <div class="col-xl-6 ml-auto mr-auto">
                                <div class="card p-4 rounded-plus bg-faded">
                                    ...
                                    <?php
                                        ...
                                        SESSION_UNSET();
                                    ?>
                                    <form id="js-login" novalidate="" action="api/registerUser.php" method="POST">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="password" name="userPass" id="userpassword" class="form-control" placeholder="" required>
                                            <div class="invalid-feedback">Заполните поле.</div>
                                        </div>
