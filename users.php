                    ...
                    <div id="c_1" class="card border shadow-0 mb-g shadow-sm-hover" data-filter-tags="oliver kopyov">
                        <div class="card-body border-faded border-top-0 border-left-0 border-right-0 rounded-top">
                            <div class="d-flex flex-row align-items-center">
                                <a href="/page_profile.php?userID=<?php echo $userInfo['PersonID'] ?>" class="status <?php getStatus($userInfo['status']) ?> mr-3">
                                    <span class="rounded-circle profile-image d-block " style="background-image:url('img/demo/avatars/<?php echo ($userInfo['photo'] != NULL)?$userInfo['photo']:"avatar-m.png"; ?>'); background-size: cover;"></span>
                                </a>
                                ...
                                <?php endif; ?>
                                    <span class="text-truncate text-truncate-xl"><?php echo $userInfo['placeWork']; ?></span>
                                </div>
                        ...
                        <div class="card-body p-0 collapse show">
                            <div class="p-3">
                                <a href="tel:<?php echo $userInfo['phone']; ?>" class="mt-1 d-block fs-sm fw-400 text-dark">
                                    <i class="fas fa-mobile-alt text-muted mr-2"></i><?php
                                        $phone = $userInfo['phone']; 
                                        echo(mb_substr($phone, 0, 2)." ".mb_substr($phone, 2, 3)."-".mb_substr($phone, 5, 3)."-".mb_substr($phone, 8, 4));
                                     ?></a>
                                <a href="mailto:<?php echo $userInfo['email']; ?>" class="mt-1 d-block fs-sm fw-400 text-dark">
                                    <i class="fas fa-mouse-pointer text-muted mr-2"></i> <?php echo $userInfo['email']; ?></a>
                                <address class="fs-sm fw-400 mt-4 text-muted">
                                    <i class="fas fa-map-pin mr-2"></i> <?php echo $userInfo['adress']; ?></address>
